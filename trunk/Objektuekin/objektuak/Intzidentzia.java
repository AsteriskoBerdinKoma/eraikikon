...
public class Intzidentzia {
	...
	//Eraikitzailea
	public Intzidentzia(int intziId, Calendar intziData, String intziLarritasuna, String intziMota, String intziDeskr, int intziIdTxart, int intziIdAtea, int intziIdTxartIrak, boolean intziGaituta, String noiztikNora)
	{
		this.id = intziId;
		this.data = intziData;
	...
	public String getNoiztikNora()
	{
		return this.noiztikNora;
	}
