				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if (gatazkatsuena != null) {
						try {
							...
							new MezuLeiho (txartId + " txartela duen irakaslea " + noiztikNora.substring(0, noiztikNora.indexOf('/')) + "-(e)tik " + noiztikNora.substring(noiztikNora.indexOf('/') + 1) + "-(e)ra irakasle gatazkatsuena izan da.", "Ados", "Intzidentzia sortua", JOptionPane.INFORMATION_MESSAGE);
						} catch (RemoteException e1) {
							new MezuLeiho("REMOTE");
							e1.printStackTrace();
